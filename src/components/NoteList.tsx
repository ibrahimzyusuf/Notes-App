    ...
    <div>
        <Row className="align-items-center mb-4">
            ...
            <Stack gap={2} direction="horizontal">
                <Link to={'/new'} className={`${styles.no_outline}`}>
                <Button variant="primary" className={`${styles.no_outline}`}>Create</Button>
                </Link>
                <Button onClick={()=>setEditTagsModalIsOpen(true)} variant="outline-secondary" className={`${styles.no_outline}`}>Edit Tags</Button>
            </Stack>
            </Col>
        </Row>
        <Form>
